...
class CdxgenClientGenerationTest {
    ...
    void testRecurseMixedProject() {
        ...
        var config = ConfigBuilder.create().analysis(new TechnolinatorConfig.AnalysisConfig(null, true, false, List.of())).enable(true).build();
    ...
    void testSimpleGradleProject(String repoName, boolean recursive) {
        ...
        var config = ConfigBuilder.create().analysis(new TechnolinatorConfig.AnalysisConfig(null, recursive, false, List.of())).enable(true).build();
